...
export async function generateMetadata(
  ...
  if (!data) return { title: `${ticker.toUpperCase()} — Not Found` }
  return {
    title: `${data.companyName} (${data.ticker}) — Pay & Pray`,
    description: `Financial metrics and SEC filings for ${data.companyName}`,
  }
}
